...
поиска и сопоставления особых точек в каждом кадре,
...
Кроме того, легко обнаружимые, заметные особенности
(например углы), содержат лишь очень малую часть
доступной информации изображения.

В SVO, особые точки извлекаются лишь из некоторых ключевых кадров,

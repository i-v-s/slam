...
извлечение дескрипторов, что выливается в высокие постоянные затраты на обработку каждого кадра.
...
Мы описываем алгоритм разрежённого сопоставления изображений 
([раздел V](#v-Оценка-движения "Оценка движения")) &mdash;
эффективный прямой метод оценки смещения от-кадра-к-кадру,
работающий путём минимизации фотометрической ошибки сопоставления особенностей,

...
На протяжении последних нескольких десятилетий очень активным полем исследования была
...
Другие применения - это виртуальная или дополненая реальность,
для которой требуется точное и быстрое определение позиции мобильного устройства. 

Центральным условием успешного использования визуальных методов
в таких интригующих областях является достижение
высочайшей *точности* и *устойчивости к ошибкам* при ограниченных вычислительных возможностях.

...
Оценка движения камеры, имеющей шесть степеней свободы, на основании данных из видеопотока была активным полем исследования на протяжении нескольких десятилетий [1-6].
...
Для методов, базирующихся на особенностях,

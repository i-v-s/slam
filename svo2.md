...
Разрежённое совмещение изображений &mdash; это эффективный метод оценки
относительного движения между последовательными кадрами. Однако,
для уменьшения ошибки (дрифта) оценки движения, очень важно
сравнить новый кадр с как можно более ранним. Один из вариантов &mdash; 
использовать старый кадр как эталонный для
совмещения изображений [16]. Однако, при увеличении расстояния между кадрами,
